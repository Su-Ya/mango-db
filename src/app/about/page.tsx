			...
			<Card>
				<CardHeader>
					<div className="flex flex-col md:flex-row items-center gap-6">
						...
						<div>
							...
							<p className="text-lg text-muted-foreground">Passionate Frontend Engineer</p>
							<div className="flex gap-2 mt-4">
								<Button variant="outline" size="icon" asChild>
									<a href="https://github.com/Su-Ya" target="_blank" rel="noopener noreferrer">
				...
				<CardContent>
					<div className="prose dark:prose-invert max-w-none text-foreground space-y-4">
						<p>
							Hi there! I'm Suwanya, a software engineer passionate about building great user experiences.
						</p>
						<p>
							This blog is where I verify my learning and share my journey in tech.
						</p>
						<p>
